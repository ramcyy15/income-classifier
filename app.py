...
def inject_styles():
    st.markdown(
        ...
        [data-testid="stAppViewContainer"] {
            background: linear-gradient(180deg, #FFF7FA 0%, #FCE4EC 40%, #FFFFFF 100%);
        }
        [data-testid="stHeader"] { background: rgba(255,255,255,0); }
        [data-testid="stSidebar"] {
            background: linear-gradient(180deg, #fcedf2 0%, #ffd1d4 100%);
            border-right: 1px solid #032e64;
        }
        h1 { color: #936773 !important; font-weight: 700; letter-spacing: 0.3px; }
        h2, h3, h4 { color: #936773 !important; font-weight: 600; }
        [data-testid="stMetricLabel"] p { color: #AD1457 !important; font-weight: 600; }
        [data-testid="stMetricValue"] { color: #2d1f23 !important; font-weight: 700; }
        [data-testid="stExpander"] {
            background: rgba(255, 255, 255, 0.8);
            border: 1px solid #F8BBD0;
            border-radius: 10px;
        }
        .helper-text { font-size: 13px; color: #6A1B4D; }
        .aid-card {
            ...
            border-radius: 10px;
            box-shadow: 0 1px 3px rgba(173, 20, 87, 0.10);
            color: #4A0E2E;
        }
        </style>
        """,
